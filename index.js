    ...
    emps.forEach(emp => {
        ...
        if(previewSrc) {
            miniThumbnail = `<div style="width:50px; height:50px; border-radius:50%; overflow:hidden; flex-shrink:0; margin-right:15px; border:2px solid #7C2A1E;">
                <img src="${previewSrc}" style="width:100%; height:100%; object-fit:cover; object-position:center center; transform:scale(1.48); transform-origin:center 52%;" loading="lazy" decoding="async">
            </div>`;
        } else {
